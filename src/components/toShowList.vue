<template>
  <div>
   <div class="main">
    ...
    <x-input title="订单号" placeholder="请输入订单号" keyboard="number" type="number" style="background-color:white;color: #333;font-size: .32rem;border-top: .16rem solid #f4f4f4;border-bottom: .16rem solid #f4f4f4;padding: .4rem .5rem" v-model="order_num"></x-input>
    ...
    <div class="btn">
        <x-button  action-type="reset" style="background-color: #ff526d;color: white;font-size: .32rem;width: 90%;margin: .4rem auto;" @click.native="submit()">发布</x-button>
    </div>
...
.des{
  width: 100%;height: 170px;outline: none;border: none;resize: none;
  font-size: .32rem;
}
  .up_img{
    width: 100%;
